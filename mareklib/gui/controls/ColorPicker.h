...
class ColorPicker: public LabeledControl {
public:
	
	ColorPicker(): LabeledControl() {
	...
	void draw() {
		...
		gui::Resources::drawString("red", x+3, y+h4-5);
		gui::Resources::drawString("green", x+3, y+h4*2 - 5);
		gui::Resources::drawString("blue", x+3, y+h4*3 - 5);
		gui::Resources::drawString("alpha", x+3, y+height - 5);
		drawLabel(x+3, y);
